...
# Answer: books_with_details is a list that contains dictionaries. The dictionaries contain key value pairs which are both strings. List is 'declared' with []. Dictionaries are declared with {}. Strings are declared with quotes.
...
def search_by_author(author):
    ...
    for book in books_with_details:
        ...
        if book.get('author') == author:
            books_by_author.append(book.get('title'))
